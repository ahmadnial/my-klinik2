    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">MSTR SATUAN PEMERIKSAAN LAB</h3>
            </div>
        ...
        <div class="modal fade" id="Delete{{ $tz->id }}">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            Yakin data : <b> {{ $tz->nm_satuan }} </b> akan di Hapus?
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            $('#buat').on('click', function() {
                ...
                if (nm_satuan != "") {
                    $.ajax({
                        ...
                        url: "{{ route('add-satuan-pemeriksaan') }}",
                        type: "POST",
                        data: {
                            nm_satuan: nm_satuan,
                        },
                        ...
                        success: function(dataResult) {
                            ...
                            return window.location.href = "{{ url('satuan-pemeriksaan-lab') }}";
                        }
                    });
                } else {
