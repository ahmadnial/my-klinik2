...
@section('mytitle', 'Kondisi Stok')
@section('konten')
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="fa fa-book">&nbsp;</i>Laporan Kondisi Stok</h3>
            </div>
            ...
            <div class="card-body">
                <div class="col-2 mb-4 input-group input-daterange" id="buttonGetStok">
                    <select id="kondisiStock" class="form-control">
                        ...
                        <option value="hampirHabis">Stock Hampir Habis</option>
                        <option value="habis">Stock Habis</option>
                    </select>
                    <div class="input-group-addon">&nbsp;&nbsp;&nbsp;</div>
                    <button class="btn btn-success" onclick="getKondisiStok()" id="btnProses">Proses</button>
                ...
                $.ajax({
                    ...
                    success: function(isDataBukuStok) {
                        ...
                        $.each(isDataBukuStok, function(key, datavalue) {
                            ...
                            const dataBaru = [
                                [datavalue.kd_obat, datavalue.nm_obat, datavalue.fm_stok_minimal,
                                    datavalue.qty, datavalue
