                ...
                <form method="POST" action="{{ url('EditRegout') }}" onkeydown="return event.key != 'Enter';"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-2">
                                <label for="">Tarif Dasar</label>
                                <input type="text" class="form-control" onkeyup="inputTarifDasar()"
                    ...
                    success: function() {
                        $('#example1').DataTable({
                            ...
                            columns: [{
                                ...
                                {
                                    data: 'trs_kp_tgl_keluar',
                                    name: 'trs_kp_tgl_keluar',
                                ...
                                {
                                    data: 'trs_kp_nm_pasien',
                                    name: 'trs_kp_nm_pasien'
                                },
                                {
                                    data: 'trs_kp_layanan',
                                    name: 'trs_kp_layanan'
                                ...
                                {
                                    data: 'trs_kp_nilai_total',
                                    name: 'trs_kp_nilai_total',
                ...
                $.ajax({
                    ...
                    success: function(isDataRegOut) {
                        $.each(isDataRegOut, function(key, datavalue) {
                            ...
                            $('#trs_kp_kd_regE').val(datavalue.trs_kp_kd_reg);
                            $('#trs_kp_tgl_keluarE').val(datavalue.trs_kp_tgl_keluar);
                            $('#trs_kp_nm_pasienE').val(datavalue.trs_kp_nm_pasien);
                            $('#trs_kp_no_mrE').val(datavalue.trs_kp_no_mr);
                            $('#trs_kp_layananE').val(datavalue.trs_kp_layanan);
                            $('#trs_kp_dokterE').val(datavalue.trs_kp_dokter);
                            $('#nm_tarif_dasarE').val(datavalue.nm_tarif_dasar);
                            $('#trs_kp_nilai_totalE').val(datavalue.trs_kp_nilai_total);
                            ...
                            $("#showAlltdkE").append(`
                                         <tr>
                                            <td>
                                                <input type="text" class="form-control" id="trs_kp_kd_trs_chart"
                                                    name="trs_kp_kd_trs_chart[]" readonly value="${datavalue.kd_trs}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="trs_kp_nm_tarif" name="trs_kp_nm_tarif[]" readonly value="${datavalue.nm_tindakan}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="trs_kp_nilai_tarif"
                                                    name="trs_kp_nilai_tarif[]" readonly value="${datavalue.nilai_tarif}">
                                            </td>
                                        </tr>
                                        `);
                        })
