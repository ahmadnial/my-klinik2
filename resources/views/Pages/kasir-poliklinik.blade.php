                    ...
                    success: function(isDataRegOut) {
                        $.each(isDataRegOut, function(key, datavalue) {
                            ...
                            for (i in detailTindakan) {
                                if (detailTindakan[i].trs_kp_kd_trs_char != null) {
                                    tindakan +=
                                        `<input type="text" class="form-control" id="trs_kp_nm_tarif" name="trs_kp_nm_tarif[]" readonly value="${detailTindakan[i].trs_kp_nm_tarif}">`;
                                } else {
                                    tindakan += ``;
                                }
                            ...
                            $("#showAlltdkE").append(`
                                     <tr>
                                        <td>
                                            <input type="text" class="form-control" id="trs_kp_kd_trs_chart"
                                                name="trs_kp_kd_trs_chart[]" readonly value="">
                                        </td>
                                        <td>
                                            ${tindakan}
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" id="trs_kp_nilai_tarif"
                                                name="trs_kp_nilai_tarif[]" readonly value="">
                                        </td>
                                    </tr>
                                `);
                            // }
