    ...
    public function createAssesment(Request $request)
    {
        ...
        try {
            ...
            $assesmentBody = [
                ...
                'fs_sg_bb' => $request->fs_sg_bb,
                'fs_sg_tb' => $request->fs_sg_tb,
                'fs_sg_imt' => $request->fs_sg_imt,
                'fs_sg_imt_note' => $request->fs_sg_imt_note,
                // 'fs_sg_masalah_gizi' => $request->fs_sg_masalah_gizi,
                // 'fs_sg_masalah_gizi_note' => $request->fs_sg_masalah_gizi_note,
