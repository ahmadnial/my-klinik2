...
class kasirPoliController extends Controller
{
    public function kasirPoli()
    {
        ...
        $getListRegOut = DB::table('ta_registrasi_keluar')->select('kd_trs_reg_out', 'trs_kp_kd_reg', 'trs_kp_tgl_keluar', 'trs_kp_no_mr', 'trs_kp_nm_pasien', 'trs_kp_layanan', 'trs_kp_dokter', 'trs_kp_nilai_total')->distinct()->get();
    ...
    public function getMonthRegOut(Request $request)
    {
        ...
        if (!$selectMonth) {
            ...
            $isListPenjualan = ta_registrasi_keluar_hdr::where('kp_tgl_keluar', 'LIKE', '%' . $selectMonth . '%')
                ->latest('created_at')
                ->distinct();
        }
    ...
    public function regOut(Request $request)
    {
        ...
        try {
            ...
            DB::table('ta_registrasi')
                ->where('fr_kd_reg', $request->trs_kp_kd_reg)
                ->update([
                    'fr_tgl_keluar' => $request->trs_kp_tgl_keluar,
                ]);

            DB::table('tc_mr')
                ->where('fs_mr', $request->trs_kp_no_mr)
                ->update([
    ...
    public function EditRegout(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            DB::table('ta_registrasi_keluar_hdr')
                ->where('kd_trs_reg_out', $request->kd_trs_reg_outE)
                ->update([
            ...
            DB::table('rekening_pendapatan_poliklinik_total')
                ->where('rk_kd_reg', $request->trs_kp_kd_regE)
                ->update([
